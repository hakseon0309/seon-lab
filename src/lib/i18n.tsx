...
const dictionaries = {
  ko: {
    brand: "SEON LAB",
    tagline: "팀원들의 근무 시프트를 한눈에 확인하세요",
    subTagline: "Apple 캘린더 구독 URL 기반 시프트 공유 서비스",
  ...
  en: {
    brand: "SEON LAB",
    tagline: "See your team's shifts at a glance",
    subTagline: "Apple Calendar subscription based shift sharing",
